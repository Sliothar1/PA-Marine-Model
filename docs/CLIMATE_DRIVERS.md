...
- **Build:** `scripts/build_cpr_aoi_week.py` → `data/processed/cpr_aoi_week_climate_drivers.csv` + `cpr_aoi_summary_climate_drivers.json` (PA local `cpr_aoi_week.csv` from ingest — gitignored).
